    ...
    async initialize() {
        ...
        compilers.forEach(compiler => {
            ...
            if (this.options.hot) {
                ...
                const HMRPluginExists = compiler.options.plugins.find(p => (p === null || p === void 0 ? void 0 : p.constructor) === compiler.webpack.HotModuleReplacementPlugin);
                if (HMRPluginExists) {
    ...
    addAdditionalEntries(compiler) {
        ...
        if (this.options.client && isWebTarget) {
            ...
            if (this.options.webSocketServer) {
                ...
                else if (typeof ((_a = webSocketServer.options) === null || _a === void 0 ? void 0 : _a.host) !== "undefined" &&
                    !isSockJSType) {
                ...
                else if (typeof ((_b = webSocketServer.options) === null || _b === void 0 ? void 0 : _b.port) !== "undefined" &&
                    !isSockJSType) {
                ...
                else if (typeof ((_c = webSocketServer.options) === null || _c === void 0 ? void 0 : _c.prefix) !== "undefined" ||
                    typeof ((_d = webSocketServer.options) === null || _d === void 0 ? void 0 : _d.path) !== "undefined") {
                    pathname =
